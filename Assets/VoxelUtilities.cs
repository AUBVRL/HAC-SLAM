...
public static class VoxelUtilities
{
    ...
    {
        Vector3 voxelVector = VoxelManager.RoundToVoxel(point);
        //Vector3 chunkVector = RoundToChunk(voxelVector);
        //if (!VoxelManager.ChunksDict.ContainsKey(chunkVector))
        //{
        //    VoxelManager.ChunksDict.Add(chunkVector, new Chunk(chunkVector, state));
        //}
        //if (!VoxelManager.ChunksDict[chunkVector].VoxelsDict.ContainsKey(voxelVector))
        //{
        //    VoxelManager.ChunksDict[chunkVector].VoxelsDict.Add(voxelVector, new Voxel(state ? PrefabsManager.addedVoxelPrefab : PrefabsManager.voxelPrefab, voxelVector, VoxelManager.ChunksDict[chunkVector].gameobject));
        //}
        VoxelManager.AddVoxel(point, state);
